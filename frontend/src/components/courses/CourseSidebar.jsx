...
import { Plus, Trash2, Wand2, BookOpen, Home } from "lucide-react"
      ...
      <div className="px-3 py-2">
        ...
        >
          ...
          {(isExpanded || isMobileOpen || isHovered) && (
            <span
              className={`ml-3 font-medium ${selectedModule === null ? "text-blue-700 dark:text-indigo-400" : "text-slate-700 dark:text-slate-300"}`}
            >
              Course Dashboard
            </span>
          )}
      ...
      {isVisible && user?.role === "Teacher" && (
        <div className="p-4 border-t border-slate-200 dark:border-slate-800">
          <div className="p-3 rounded-lg bg-blue-50 dark:bg-blue-900/20 text-xs text-blue-700 dark:text-blue-300">
            ...
            <p className="mt-1 opacity-80">You can add, edit, and delete modules</p>
          </div>
        </div>
      )}
    </aside>
