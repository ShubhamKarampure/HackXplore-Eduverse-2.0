...
const studentItems = [
  ...
  { icon: <IoMdSchool size={22} />, name: "Courses", path: "/all-courses" },
  { icon: <FaFolderOpen size={22} />, name: "My Courses", path: "/my-courses" },
...
const teacherItems = [
  ...
  { icon: <FaChalkboardTeacher size={22} />, name: "My Courses", path: "/my-courses" },
  { icon: <FaCalendarAlt size={22} />, name: "Calendar", path: "/calendar" },
  { icon: <FaUserCircle size={22} />, name: "User Profile", path: "/profile" },
];
        ...
        <nav className="mb-6">
          <div className="flex flex-col gap-4">
            <div>
              ...
              >
                {isExpanded || isHovered || isMobileOpen ? (
                  user?.role === 'Teacher' ? "Instructor Menu" : "Student Menu"
                ) : (
                  <HorizontaLDots />
                )}
              </h2>
              {renderMenuItems(
                user?.role === 'Teacher' ? teacherItems : studentItems, 
                user?.role || 'main'
              )}
            </div>
          </div>
